...
public class RFID_CHART {
	...
	private static final double THRED_HOLED_RSSI = 1000;
	...
	String[] tagids = new String[] { "E20090276205016224301CB3",
			"E2009027620501622470196B", "E20090276205016224901641",
			"E20090276205016224201CB2" };
	// »¬¶¯´°¿Ú
	...
	public RFID_CHART() throws AlienReaderException, IOException,
	...
	private void addToChart(Tag[] tagList) {
		// TODO Auto-generated method stub
		double[] chartArray = new double[tagNum];
		for (int i = 0; i < tagList.length; i++) {
			Tag tag = tagList[i];
			int index = tags.indexOf(tag.getTagID());
			// System.out.println(tag.getTagID() + "," + tag.getRSSI());
			if (index > -1) {
				chartArray[index] = tag.getRSSI();
			}
		}
		chartDrawer.addData(chartArray);
