 ...
 *
 */
public class RotateGui extends JFrame {
	...
	private int center[] = new int[] { 300, 200 };
	...
	private int p1[] = new int[] { 100, 200 };
	private int p2[] = new int[] { 500, 200 };
	...
	public void refresh() {
		p1 = new int[] { center[0] - lineWidth / 2, 200 };
		p2 = new int[] { center[0] + lineWidth / 2, 200 };
		rotate(angle, center);
		repaint();
	}
