...
import com.impinj.octanesdk.PcBits;
...
import com.impinj.octanesdk.TagOp;
...
import com.impinj.octanesdk.TargetTag;
import com.impinj.octanesdk.WordPointers;
    ...
    void programEpc(String currentEpc, short currentPC, String newEpc)
        ...
        if ((currentEpc.length() % 4 != 0) || (newEpc.length() % 4 != 0)) {
            throw new Exception("EPCs must be a multiple of 16- bits: "
                    + currentEpc.toString() + "  " + newEpc.toString());
        }
        ...
        System.out.println("   EPC " + currentEpc.toString() + " to "
                + newEpc.toString());
